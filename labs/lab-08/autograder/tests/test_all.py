...
class TestAll(unittest.TestCase):
    ...
    @weight(1)
    def test_set(self):
        self.assert_exists(["set.h"])
        self.assert_cpp_tests(["set.cpp", "test_set.cpp"], "test_set")

    @weight(1)
    def test_set_analysis(self):
        self.assert_exists(["set.h", "set.cpp", "test_set.cpp"])
        self.assert_analysis_tests("set.md")

    @weight(1)
    def test_map(self):
        self.assert_exists(["map.h"])
        self.assert_cpp_tests(["map.cpp", "test_map.cpp"], "test_map")

    @weight(1)
    def test_map_analysis(self):
        self.assert_exists(["map.h", "map.cpp", "test_map.cpp"])
        self.assert_analysis_tests("map.md")

    @weight(1)
    def test_sequence(self):
        self.assert_exists(["sequence.h"])
        self.assert_cpp_tests(["sequence.cpp", "test_sequence.cpp"], "test_sequence")

    @weight(1)
    def test_sequence_analysis(self):
        self.assert_exists(["sequence.h", "sequence.cpp", "test_sequence.cpp"])
        self.assert_analysis_tests("sequence.md")
